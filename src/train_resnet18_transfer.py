...
def train_model(model, train_loader, val_loader, criterion, optimizer):
    history = []
    best_val_acc = 0.0
    best_model_path = WEIGHTS_DIR / "resnet18_best.pth"
...
def save_history_and_plot(history):
    ...
    history_path = TABLES_DIR / "resnet18_history.csv"
    ...
    plt.tight_layout()
    curve_path = FIGURES_DIR / "resnet18_curves.png"
...
def evaluate_on_test(model, test_loader, class_names):
    ...
    metrics_path = TABLES_DIR / "resnet18_test_metrics.csv"
    ...
    cm_path = FIGURES_DIR / "resnet18_confusion_matrix.png"
